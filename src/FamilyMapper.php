...
use SnowIO\Akeneo2DataModel\AttributeGroup as Akeneo2AttributeGroup;
use SnowIO\Akeneo2DataModel\FamilyData;
use SnowIO\Akeneo2DataModel\FamilyAttributeData;
...
final class FamilyMapper extends DataMapper
{
    ...
    {
        $groupsWithKeys = WithKeys::of(function (Akeneo2AttributeGroup $attributeGroup) {
