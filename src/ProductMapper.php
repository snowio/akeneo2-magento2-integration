...
use SnowIO\Akeneo2DataModel\ProductData as Akeneo2ProductData;
...
final class ProductMapper extends DataMapper
{
    ...
    public function __invoke(Akeneo2ProductData $akeneoProduct): Magento2ProductData
    {
        ...
        $visibility = $akeneoProduct->getProperties()->getParent() ? ProductVisibility::NOT_VISIBLE_INDIVIDUALLY : ProductVisibility::CATALOG_SEARCH;
